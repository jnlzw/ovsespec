 ...
 *
 * @param projectRoot - The root directory of the project (where `ovsespec/` lives)
...
export function readProjectConfig(projectRoot: string): ProjectConfig | null {
  ...
  try {
    ...
    if (!raw || typeof raw !== 'object') {
      console.warn(`ovsespec/config.yaml is not a valid YAML object`);
      return null;
    }
    ...
    console.warn(`Failed to parse ovsespec/config.yaml:`, error);
    return null;
  }
}
