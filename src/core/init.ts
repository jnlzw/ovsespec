...
export class InitCommand {
  ...
  private async createDirectoryStructure(ovsespecPath: string, extendMode: boolean): Promise<void> {
    if (extendMode) {
  ...
  private async createConfig(ovsespecPath: string, extendMode: boolean): Promise<'created' | 'exists' | 'skipped'> {
