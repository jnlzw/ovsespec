...
Instructions for AI coding assistants using OvseSpec for spec-driven development.

## TL;DR Quick Checklist
- Search existing work: `ovsespec spec list --long`, `ovsespec list`
...
- Validate with `ovsespec validate [change-id] --strict`
...
- **AND** summarize which assistant files were created versus refreshed (e.g., `CLAUDE.md (created)`, `.cursor/commands/ovsespec-apply.md (refreshed)`)
