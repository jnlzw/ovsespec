...
- [x] Add test for `ovsespec status --change <scaffolded-change>`
- [x] Add test for `ovsespec next --change <scaffolded-change>`
- [x] Add test for `ovsespec instructions proposal --change <scaffolded-change>`
...
- [x] Manual test: `ovsespec new change foo && ovsespec status --change foo`
- [x] Manual test: `ovsespec new change foo && ovsespec view` shows foo in Draft
- [x] Validate with `ovsespec validate unify-change-state-model --strict`
