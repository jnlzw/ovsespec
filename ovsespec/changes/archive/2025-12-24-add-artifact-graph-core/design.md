...
This module will coexist with the current OvseSpec system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing OvseSpec functionality
...
**Resolution order:**
1. `${XDG_DATA_HOME:-~/.local/share}/ovsespec/schemas/<name>.yaml` - Global user override
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/ovsespec/schemas/<name>.yaml`
