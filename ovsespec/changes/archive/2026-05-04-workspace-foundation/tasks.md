...
- [x] 1.2 Settle `.ovsespec-workspace/` as the workspace metadata directory
...
- [x] 1.7 Capture that planning can include repos or monorepo folders without repo-local OvseSpec state
...
- [x] 2.1 Add workspace path constants and helpers for `.ovsespec-workspace/`, `workspace.yaml`, `local.yaml`, and root `changes/`
...
- [x] 2.5 Ensure repo-local `ovsespec/` projects are not mistaken for coordination workspaces
...
- [x] 3.3 Ensure local-state files are treated as machine-local and OvseSpec-created workspaces exclude `.ovsespec-workspace/local.yaml` from portable collaboration state
...
- [x] 4.2 Document how `.ovsespec-workspace/` differs from repo-local `ovsespec/`
...
- [x] 4.6 Document linked repos/folders without repo-local OvseSpec and large-monorepo planning behavior
...
- [x] 5.6 Add tests or docs coverage that linked repos/folders do not require repo-local `ovsespec/`
...
- [x] 5.9 Add tests or docs coverage for `.ovsespec-workspace/local.yaml` exclusion in OvseSpec-created workspaces
- [x] 5.10 Run `ovsespec validate workspace-foundation --strict`
