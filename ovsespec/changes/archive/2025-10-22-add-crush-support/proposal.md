## Why
Add support for Crush AI assistant in OvseSpec to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/ovsespec/ (proposal.md, apply.md, archive.md)