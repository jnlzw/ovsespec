...
- **`ovsespec list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (ovsespec change show)
...
- Use `ovsespec list --specs` to discover current capabilities
