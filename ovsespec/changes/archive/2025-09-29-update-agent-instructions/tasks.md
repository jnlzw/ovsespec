...
## 1. Restructure OvseSpec README.md
...
- [x] 3.1 Document `ovsespec list` and `ovsespec list --specs` commands
- [x] 3.2 Document `ovsespec show` with all flags and interactive mode
- [x] 3.3 Document `ovsespec diff [change]` for viewing spec differences
- [x] 3.4 Document `ovsespec archive` with --skip-specs option
- [x] 3.5 Document `ovsespec validate` with --strict and batch modes
- [x] 3.6 Document `ovsespec init` and `ovsespec update` commands
...
- [x] 8.2 Run `ovsespec init` to verify CLAUDE.md generation
