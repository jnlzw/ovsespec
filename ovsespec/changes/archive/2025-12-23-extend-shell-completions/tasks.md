...
- [x] Verify bash completions work manually: `ovsespec completion install bash && exec bash`
...
- [x] Verify fish completions work manually: `ovsespec completion install fish`
...
- [x] Run `ovsespec validate extend-shell-completions --strict` and resolve all issues
- [x] Update error messages to list all four supported shells
- [x] Verify `ovsespec completion --help` documentation is current
