...
- Update `ovsespec-new-change` skill to prompt user for schema selection
- Update `ovsespec-continue-change` skill to work with any schema's artifacts
- Update `ovsespec-apply-change` skill to handle schema-specific task structures
