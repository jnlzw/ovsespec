...
- [x] 1.2 Ensure `ovsespec templates --schema <name>` returns artifact list for any schema
...
- [x] 2.3 Pass selected schema to `ovsespec new change --schema <name>`
...
- [x] 3.2 Read artifact list dynamically from `ovsespec status --json`
