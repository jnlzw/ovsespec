...
- [x] 7.1 After merge and verification, create new spec file at ovsespec/specs/ci-nix-validation/spec.md
- [x] 7.2 Move change directory to ovsespec/changes/archive/[date]-add-nix-ci-validation/
- [x] 7.3 Run `ovsespec validate --strict` to confirm archived change passes
