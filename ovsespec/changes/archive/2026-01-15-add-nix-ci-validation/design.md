...
OvseSpec recently added Nix flake support to enable Nix users to install the tool. This includes:
...
- Running OvseSpec's full test suite through Nix build - existing CI already does this
...
- **Q**: Should we run full OvseSpec tests through the Nix build?
