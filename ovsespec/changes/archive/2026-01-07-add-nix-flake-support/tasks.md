...
- [x] 4.2 Verify binary ends up in $out/bin/ovsespec
...
- [x] 5.4 Set meta.mainProgram = "ovsespec"

## 6. Configure App Entry Point

- [x] 6.1 Add apps output with forAllSystems
- [x] 6.2 Set default app to ovsespec binary
...
- [ ] 9.5 Test `nix run github:Fission-AI/OvseSpec -- init` after merge to main
