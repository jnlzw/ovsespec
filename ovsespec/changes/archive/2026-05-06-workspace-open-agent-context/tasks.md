...
- [x] 3.2 Create or refresh root `AGENTS.md` with an OvseSpec-managed workspace guidance block
...
- [x] 4.1 Add `ovsespec workspace open [name]`
- [x] 4.2 Support `ovsespec workspace open --workspace <name>` as an alias for the positional name
...
- [x] 4.8 Report unresolved workspace selection clearly and suggest `ovsespec workspace setup`
...
- [x] 6.6 Report skipped broken links with `ovsespec workspace doctor` as the repair path
...
- [x] 8.1 Run `node bin/ovsespec.js validate workspace-open-agent-context --strict`
