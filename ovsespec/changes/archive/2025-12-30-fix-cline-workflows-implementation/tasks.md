...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/ovsespec-*.md` to `.clinerules/workflows/ovsespec-*.md`
...
- [x] Verify the change follows OvseSpec conventions
