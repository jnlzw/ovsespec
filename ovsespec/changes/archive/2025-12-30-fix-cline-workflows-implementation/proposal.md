...
- **BREAKING**: Existing Cline users will need to re-run `ovsespec init` to get the corrected workflow files
...
- Modified files: `.clinerules/workflows/ovsespec-*.md` (moved from `.clinerules/ovsespec-*.md`)
