## Why
Need a command to archive completed changes to the archive folder with proper date prefixing, following OvseSpec conventions. Currently changes must be manually moved and renamed.
...
- Update main specs from the change's future state specs (copy from `changes/[name]/specs/` to `ovsespec/specs/`)
