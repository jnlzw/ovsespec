...
- [x] 3.3 Run `ovsespec init --tools opencode` in a temp directory and verify:
  - Command files in `.opencode/command/` contain `/ovsx-` references (not `/ovsx:`)
  - Skill files in `.opencode/skills/` contain `/ovsx-` references (not `/ovsx:`)
