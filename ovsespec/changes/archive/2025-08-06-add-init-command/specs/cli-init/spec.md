...
- `README.md` containing complete OvseSpec instructions for AI assistants
...
- Claude Code (updates/creates CLAUDE.md with OvseSpec markers)
- Cursor (future)
- Aider (future)
...
See @ovsespec/README.md for detailed conventions and guidelines.
<!-- OVSESPEC:END -->
```
...
- Use `<!-- OVSESPEC:START -->` to mark the beginning of managed content
- Use `<!-- OVSESPEC:END -->` to mark the end of managed content
- Allow OvseSpec to update its content without affecting user customizations
...
WHEN `ovsespec/` directory already exists
THEN display error with ora fail indicator:
"✖ Error: OvseSpec seems to already be initialized. Use 'ovsespec update' to update the structure."
...
```
✔ OvseSpec initialized successfully!

Next steps - Copy these prompts to Claude:

────────────────────────────────────────────────────────────
1. Populate your project context:
   "Please read ovsespec/project.md and help me fill it out
    with details about my project, tech stack, and conventions"

2. Create your first change proposal:
   "I want to add [YOUR FEATURE HERE]. Please create an
    OvseSpec change proposal for this feature"

3. Learn the OvseSpec workflow:
   "Please explain the OvseSpec workflow from ovsespec/README.md
