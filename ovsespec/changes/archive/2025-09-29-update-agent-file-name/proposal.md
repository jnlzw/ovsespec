...
## Problem
The agent instructions live in `ovsespec/README.md`, which clashes with conventional project README usage and creates confusion for tooling and contributors.

## Solution
Rename the agent instruction file to `ovsespec/AGENTS.md` and update OvseSpec tooling to use the new filename:
- `ovsespec init` generates `AGENTS.md` instead of `README.md`
...
## Success Metrics
- `ovsespec init` creates `ovsespec/AGENTS.md`
- `ovsespec update` refreshes `AGENTS.md`
- All specs reference `ovsespec/AGENTS.md`
