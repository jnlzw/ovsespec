# Adopt Future State Storage for OvseSpec Changes
...
- Add new `ovsespec-conventions` capability to document these conventions



## Impact

- Affected specs: New `ovsespec-conventions` capability
- Affected code: 
  - ovsespec/README.md (lines 85-108)
  - docs/PRD.md (lines 376-382, 778-783)
  - docs/ovsespec-walkthrough.md (lines 58-62, 112-126)
  - ovsespec/changes/add-init-command/ (migration needed)
