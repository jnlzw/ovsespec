...
- [x] 1.1 Update ovsespec/README.md section on "Creating a Change Proposal"
...
- [x] 3.2 Update docs/ovsespec-walkthrough.md
  - [x] Replace diff examples with future state examples
  - [x] Ensure the walkthrough reflects new approach

## 4. Create New Spec
- [x] 4.1 Finalize ovsespec-conventions spec in main specs/ directory
