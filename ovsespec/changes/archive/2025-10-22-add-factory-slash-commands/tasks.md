...
- [x] 2.1 Create shared templates for Factory's `ovsespec-proposal`, `ovsespec-apply`, and `ovsespec-archive` custom commands following Factory's CLI format.
- [x] 2.2 Wire the templates into init/update so generation happens on create and refresh respects OvseSpec markers.
