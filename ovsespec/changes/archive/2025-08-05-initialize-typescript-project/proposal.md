...
## Why
The OvseSpec project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up OvseSpec file structures and keep AI instructions updated.
