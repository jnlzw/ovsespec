...
## 1. Extend Init Guard
- [x] 1.1 Detect existing OvseSpec structures at the start of `ovsespec init` and enter an extend mode instead of failing.
...
## 4. Verification
- [x] 4.1 Add tests covering rerunning `ovsespec init` to add another tool and the scenario where the user declines to add anything.
