...
OvseSpec currently discovers active changes as immediate directories under `ovsespec/changes/`, and change names are kebab-case identifiers. Keep these changes as flat siblings until formal change-stacking metadata is available.
...
ovsespec/changes/workspace-reimplementation-roadmap/README.md and
ovsespec/changes/workspace-reimplementation-roadmap/POC_REFERENCE_GUIDE.md
