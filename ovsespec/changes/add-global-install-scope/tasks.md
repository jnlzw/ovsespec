...
- [ ] 1.4 Extend `ovsespec config list` output to show install scope and source (`explicit`, `new-default`, `legacy-default`)
...
- [ ] 4.1 Add scope override flag to `ovsespec init` (`--scope global|project`)
...
- [ ] 5.1 Add scope override flag to `ovsespec update` (`--scope global|project`)
...
- [ ] 6.1 Extend `ovsespec config profile` interactive flow to select install scope
