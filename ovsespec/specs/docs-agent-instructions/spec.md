...
- **WHEN** `ovsespec/AGENTS.md` is regenerated or updated
...
`ovsespec/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`ovsespec/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `ovsespec validate`.
...
- **WHEN** reorganizing `ovsespec/AGENTS.md`
...
- **WHEN** `ovsespec/AGENTS.md` explains how to write `spec.md`
