 ...
 * - Opt-out via OVSESPEC_TELEMETRY=0 or DO_NOT_TRACK=1
...
const POSTHOG_HOST = 'https://edge.ovsespec.dev';
...
export function isTelemetryEnabled() {
    ...
    if (process.env.OVSESPEC_TELEMETRY === '0') {
        return false;
    }
 ...
 * @param version - The OvseSpec version
 */
...
export async function maybeShowTelemetryNotice() {
    ...
    try {
        ...
        // Display notice
        console.log('Note: OvseSpec collects anonymous usage stats. Opt out: OVSESPEC_TELEMETRY=0');
        // Mark as seen
