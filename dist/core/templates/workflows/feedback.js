export function getFeedbackSkillTemplate() {
    return {
        name: 'feedback',
        description: 'Collect and submit user feedback about OvseSpec with context enrichment and anonymization.',
        instructions: `Help the user submit feedback about OvseSpec.
...
5. **Submit on confirmation**
   - Use the \`ovsespec feedback\` command to submit
   - Format: \`ovsespec feedback "title" --body "body content"\`
