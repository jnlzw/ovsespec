...
/**
 * Registry of all OvseSpec CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY = [
    ...
    },
    {
        ...
        flags: [
            ...
            {
                name: 'concurrency',
                description: 'Max concurrent validations (defaults to env OVSESPEC_CONCURRENCY or 6)',
                takesValue: true,
            },
    ...
    {
        name: 'change',
        description: 'Manage OvseSpec change proposals (deprecated)',
        flags: [],
        subcommands: [
            {
                name: 'show',
    ...
    {
        name: 'spec',
        description: 'Manage OvseSpec specifications',
        flags: [],
        subcommands: [
            {
                name: 'show',
