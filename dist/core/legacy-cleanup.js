 ...
 */
export function hasOvseSpecMarkers(content) {
    return (content.includes(OVSESPEC_MARKERS.start) && content.includes(OVSESPEC_MARKERS.end));
}
/**
 ...
 */
export function isOnlyOvseSpecContent(content) {
