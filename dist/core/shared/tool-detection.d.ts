 ...
 */
export declare const SKILL_NAMES: readonly ["ovsespec-explore", "ovsespec-new-change", "ovsespec-continue-change", "ovsespec-apply-change", "ovsespec-ff-change", "ovsespec-sync-specs", "ovsespec-archive-change", "ovsespec-bulk-archive-change", "ovsespec-verify-change", "ovsespec-onboard", "ovsespec-propose", "ovsespec-paas-test-deploy"];
export type SkillName = (typeof SKILL_NAMES)[number];
/**
 * IDs of command templates created by ovsespec init.
 */
export declare const COMMAND_IDS: readonly ["explore", "new", "continue", "apply", "ff", "sync", "archive", "bulk-archive", "verify", "onboard", "propose", "paas-test-deploy"];
