...
export class ShowCommand {
    ...
    async showDirect(itemName, params) {
        ...
        if (!params.typeOverride && isChange && isSpec) {
            ...
            console.error('Pass --type change|spec, or use: ovsespec change show / ovsespec spec show');
            process.exitCode = 1;
            return;
        }
    ...
    printNonInteractiveHint() {
        ...
        console.error('  ovsespec show <item>');
        console.error('  ovsespec change show');
        console.error('  ovsespec spec show');
