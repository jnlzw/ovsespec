...
describe('interactive utilities', () => {
  let originalOvseSpecInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalOvseSpecInteractive = process.env.OVSE_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalOvseSpecInteractive !== undefined) {
      process.env.OVSE_SPEC_INTERACTIVE = originalOvseSpecInteractive;
    } else {
      delete process.env.OVSE_SPEC_INTERACTIVE;
    }
  ...
  describe('isInteractive', () => {
    ...
    it('should return false when OVSE_SPEC_INTERACTIVE env var is 0', () => {
