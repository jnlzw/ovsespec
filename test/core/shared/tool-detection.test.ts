...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('ovsespec-explore');
      expect(SKILL_NAMES).toContain('ovsespec-new-change');
      expect(SKILL_NAMES).toContain('ovsespec-continue-change');
      expect(SKILL_NAMES).toContain('ovsespec-apply-change');
      expect(SKILL_NAMES).toContain('ovsespec-ff-change');
      expect(SKILL_NAMES).toContain('ovsespec-sync-specs');
      expect(SKILL_NAMES).toContain('ovsespec-archive-change');
      expect(SKILL_NAMES).toContain('ovsespec-bulk-archive-change');
      expect(SKILL_NAMES).toContain('ovsespec-verify-change');
      expect(SKILL_NAMES).toContain('ovsespec-onboard');
      expect(SKILL_NAMES).toContain('ovsespec-propose');
      expect(SKILL_NAMES).toContain('ovsespec-paas-test-deploy');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'ovsespec-explore');
