  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize OvseSpec',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('# Fish completion script for OvseSpec CLI');
      expect(script).toContain('function __fish_ovsespec');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_ovsespec_using_subcommand');
      expect(script).toContain('function __fish_ovsespec_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c ovsespec");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize OvseSpec'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_ovsespec_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_ovsespec_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_ovsespec_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_ovsespec_items');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_ovsespec_schemas');
      expect(script).toContain('ovsespec __complete schemas 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_ovsespec_changes');
      expect(script).toContain('ovsespec __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_ovsespec_specs');
      expect(script).toContain('ovsespec __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_ovsespec_items');
      expect(script).toContain('__fish_ovsespec_changes');
      expect(script).toContain('__fish_ovsespec_specs');
    });
